...
|  Version  | Docs  | Status |
| :--- 	  | :--- 	  | :--- 	  |
|  [![PyPi Version](https://img.shields.io/pypi/v/pynastran.svg)](https://pypi.python.org/pypi/pyNastran) | [docs](https://pynastran-git.readthedocs.io/en/1.3/) | [![Build Status](https://img.shields.io/travis/SteveDoyle2/pyNastran/1.3.svg)](https://travis-ci.org/SteveDoyle2/pyNastran) [![Coverage Status](image:: https://codecov.io/gh/SteveDoyle2/pyNastran/branch/1.3/graph/badge.svg)](https://codecov.io/gh/SteveDoyle2/pyNastran/branch/1.3) |
