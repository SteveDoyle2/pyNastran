...
class TestOP2(Tester):
    ...
    def test_op2_solid_shell_bar_01_gpforce_xyz(self):
        ...
        i_transform_1, beta_transforms = op2_1.get_displacement_index_transforms()
    ...
    def test_op2_solid_shell_bar_01_gpforce_radial(self):
        folder = os.path.abspath(os.path.join(test_path, '..', 'models', 'sol_101_elements'))
        bdf_filename1 = os.path.join(folder, 'static_solid_shell_bar_radial.bdf')
        op2_filename1 = os.path.join(folder, 'static_solid_shell_bar_radial.op2')
        op2_1 = read_op2_geom(op2_filename1)
