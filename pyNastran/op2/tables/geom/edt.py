...
class EDT:
    ...
    def __init__(self, op2: OP2Geom):
        ...
        self.edt_map = {
            ...
            #(8001, 80, 511): ['???', self._read_fake],
            #(8001, 80, 511): ['???', self._read_fake],
            (8104, 81, 620): ['SPLINE7', self._read_fake],
            (9004, 90, 619): ['MASSSET', self.read_massset],
            (9102, 91, 629): ['MONGRP', self._read_fake],
            (9200, 92, 632): ['FBODYLD', self._read_fake],
            (9300, 93, 631): ['FBODYSB', self.read_stop],
            (9604, 96, 678): ['AEGRID', self._read_fake],
            (9804, 98, 680): ['AEQUAD4', self._read_fake],
            (10004, 100, 682): ['SPLINRB', self._read_fake],
            (10104, 101, 683): ['SPBLND1', self.read_sblnd1],
            (10404, 104, 686): ['MONSUM', self._read_fake],
            (10504, 105, 687): ['MONCNCM', self._read_fake],
            (12004, 120, 880): ['TRIM2', self._read_fake],
            (12704, 127, 932): ['MONSUM1', self._read_fake],
            (12804, 128, 945): ['MONSUMT', self._read_fake],
            (12904, 129, 954): ['CONCTL', self._read_fake],
