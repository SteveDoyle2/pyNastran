...
class NonlinearQuadObject(StressObject):
    ...
    def write_f06(self, header, pageStamp, f, pageNum=1, is_mag_phase=None):
...
class HyperelasticQuadObject(StressObject):
    ...
    def write_f06(self, header, pageStamp, f, pageNum=1, is_mag_phase=False):  # .. todo:: doesnt support CTRIA3NL (calls them CQUAD4s)
...
class NonlinearRodObject(StressObject):
    ...
    def write_f06(self, header, pageStamp, f, pageNum=1, is_mag_phase=False):  # .. todo:: doesnt support CONROD/CTUBE (calls them CRODs)
        """
        ::
