...
class FlutterGui(LoggableGui):
    ...
    def _apply_settings(self, data: dict[str, Any]) -> None:
        ...
        ] + self.trade_layout.get_load_settings('lineedit')
        ...
        ] + self.trade_layout.get_load_settings('combobox')
    ...
    def setup_layout(self) -> None:
        ...
        vbox_file = self._setup_file_layout(ifile=0)
    ...
    def _setup_file_layout(self, ifile: int=0) -> QVBoxLayout:
        file_row = 0
        hbox = QGridLayout()
