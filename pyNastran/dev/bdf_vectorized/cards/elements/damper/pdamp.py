...
class PDAMP(Property):
    """
    Specifies the damping, damping coefficient, and stress coefficient of a
    scalar damptic (damper) element (CDAMP1 or CDAMP3 entry).
    """
    type = 'PDAMP'
    ...
    def build(self):
        if self.n:
            ...
            #: Bi damp property value. (Real)
            self.B = array(self._B)
