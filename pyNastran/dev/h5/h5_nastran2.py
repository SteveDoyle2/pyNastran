...
class H5NastranReader(VTKPythonAlgorithmBase):
    ...
    def RequestData(self, request, inInfo, outInfo):
        ...
        model, ugrid, root = get_nastran_ugrid(hdf5_filename)
        ...
        for grp_name in f:
            ...
            _fill_vtk_unstructured_grid(geom_model, vtk_ugrid)
            #grp = f[grp_name]
            #cells = grp['cells'][:]
...
def main():
    ...
    #hdf5_filename = r'C:\NASA\m4\formats\git\pyNastran\models\msc\mode_echo.h5'
