...
class TestMassElements(unittest.TestCase):
    ...
    def test_conm1(self):
        ...
        conm1_id = model.add_conm1(eid, nid, mass_matrix, cid=0, comment='conm1')
        model.conm1.write(size=8)
        model.conm1.write(size=16)
        model.conm1.write(size=16, is_double=True)
        #model.conm1.raw_fields()
        model.conm1.mass_matrix()
    ...
    def test_cmass1(self):
        ...
        g2 = 2
        c2 = 4
        cmass1_id = model.add_cmass1(eid, pid, [g1, g2], c1, c2, comment='cmass1')
        model.cmass1.write(size=8)
        model.cmass1.write(size=16)
        model.cmass1.write(size=16, is_double=True)
        #cmass1.raw_fields()

        mass = 142.
        pmass_id = model.add_pmass(pid, mass, comment='pmass')
        model.pmass.write(size=8)
        model.pmass.write(size=16)
        model.pmass.write(size=16, is_double=True)
        #pmass.raw_fields()

        eid = 10
        cmass2_id = model.add_cmass2(eid, mass, [g1, g2], c1, c2, comment='cmass2')
        model.cmass2.write(size=8)
        model.cmass2.write(size=16)
        model.cmass2.write(size=16, is_double=True)
        #cmass2.raw_fields()
        ...
        if run_opt:
            ...
            model.ddval.write(size=8)
            model.ddval.write(size=16)
            model.ddval.write(size=16, is_double=True)
            #ddval.raw_fields()
        model.validate()
        model.cross_reference()
    ...
    def test_mass_3_4(self):
        ...
        s1 = 1
        s2 = 2
        cmass3_id = model.add_cmass3(eid, pid, [s1, s2], comment='cmass3')
        model.cmass3.write(size=8)
        model.cmass3.write(size=16)
        model.cmass3.write(size=16, is_double=True)
        #cmass3.raw_fields()
        ...
        eid = 10
        cmass4_id = model.add_cmass4(eid, mass, [s1, s2], comment='cmass4')
        model.cmass4.write(size=8)
        model.cmass4.write(size=16)
        model.cmass4.write(size=16, is_double=True)
        #cmass4.raw_fields()
