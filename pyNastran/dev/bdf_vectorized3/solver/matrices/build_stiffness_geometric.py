...
def build_KDgg(model: BDF,
               ndof: int,
               dof_map: DOF_MAP,
               u_global: np.ndarray) -> dok_matrix:
...
def build_KDgg_bar_beam(model: BDF,
    ...
    for elem in [model.cbar, model.cbeam]:
        ...
        _KDbb_bar_beam(model, elem, coo,
                       KDgg, dof_map, xb, fdtype=fdtype)
