...
def test_static_completeness_dense():
...
def test_static_completeness_sparse():
...
def test_redundant_load_discarded():
...
def test_multiple_loads_independent():
...
def test_build_inertia_load_vectors():
...
def test_drive_point_frf_at_dc():
...
def test_mass_participation_factors():
    ...
    """
    from pyNastran.dev.bdf_vectorized3.solver.utils_modes import compute_mass_participation
...
def test_mass_participation_partial_modes():
...
if __name__ == "__main__":
    test_static_completeness_dense()
    print("PASS: test_static_completeness_dense")

    test_static_completeness_sparse()
    print("PASS: test_static_completeness_sparse")

    test_orthogonality()
    print("PASS: test_orthogonality")

    test_redundant_load_discarded()
    print("PASS: test_redundant_load_discarded")

    test_effective_mass_completeness()
    print("PASS: test_effective_mass_completeness")

    test_multiple_loads_independent()
    print("PASS: test_multiple_loads_independent")

    test_build_inertia_load_vectors()
    print("PASS: test_build_inertia_load_vectors")

    test_drive_point_frf_at_dc()
    print("PASS: test_drive_point_frf_at_dc")

    test_mass_participation_factors()
    print("PASS: test_mass_participation_factors")

    test_mass_participation_partial_modes()
    print("PASS: test_mass_participation_partial_modes")

    print("\nAll RESVEC tests passed.")
