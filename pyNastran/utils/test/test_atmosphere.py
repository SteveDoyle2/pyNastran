...
class TestAtm(unittest.TestCase):
    ...
    def test_velocity(self):
        ...
        vel_fts_55_2p4 = atm_velocity2(55000., 2.4)
    ...
    def test_mach(self):
        ...
        """
        mach_a = atm_mach2(14000., 743.011549709834) #, debug=False)
        mach_b = atm_mach2(14000., 2122.8901420281)
    ...
    def test_reynolds(self):
        ...
        #reynolds1 = atm_unit_reynolds_number1a(55000., 2.4)
        reynolds2 = atm_unit_reynolds_number1b(55000., 2.4)
        #self.assertEqual(reynolds1, 2244166.3810534105)
        self.assertEqual(reynolds2, 2244166.3810534105)
    ...
    def test_equiv_airspeed(self):
        ...
        assert np.allclose(veq2, 1115.5461442719434)
        ...
        veq3 = atm_equivalent_airspeed2(alt/1000., mach, alt_units='kft', eas_units='ft/s')
        ...
        assert np.allclose(veq2, 340.0184647740884)

    def test_atm_kinematic_viscosity_nu(self):
        """tests atm_kinematic_viscosity_mu"""
        mu = atm_kinematic_viscosity_nu2(10., alt_units='kft', visc_units='ft^2/s')
        self.assertEqual(mu, 0.00020075264466844382)

        mu = atm_kinematic_viscosity_nu2(5000., alt_units='m', visc_units='m^2/s')
    ...
    def test_get_alt_for_density(self):
        ...
        for alt_target in alt_targets:
            rho1 = atm_density2(alt_target * 1000.)
            alt1 = get_alt_for_density2(rho1)
    ...
    def test_get_alt_for_pressure(self):
        ...
        alt_targets = [0., 10., 20., 30., 40., 50.]
        for alt_target in alt_targets:
            pressure1 = atm_pressure2(alt_target*1000.)
            #alt1 = get_alt_for_pressure(pressure1, tol=5., SI=False, nmax=20)
            alt1 = get_alt_for_pressure2(pressure1, nmax=20)
    ...
    def test_get_alt_for_q_with_constant_mach(self):
        ...
        alt = get_alt_for_q_with_constant_mach2(534.2, 0.8)
        ...
        alt_a = get_alt_for_q_with_constant_mach2(600., 0.8)
        alt_b = get_alt_for_q_with_constant_mach2(400., 0.8)
    ...
    def test_get_alt_for_q_with_constant_mach2(self):
        ...
        alt_targets = [0., 10., 20., 30., 40., 50.]
        for alt_target in alt_targets:
            pressure1 = atm_dynamic_pressure2(alt_target*1000., mach)
            alt1 = get_alt_for_q_with_constant_mach2(pressure1, mach)
    ...
    def get_alt_for_eas_with_constant_mach(self):
        ...
        alt_targets = [0., 10., 20., 30., 40., 50.]
        for alt_target in alt_targets:
            veq1 = atm_equivalent_airspeed2(alt_target*1000., mach, alt_units='ft', eas_units='ft/s')
            veq2 = atm_equivalent_airspeed2(alt_target, mach, alt_units='kft', eas_units='knots')
            alt1 = get_alt_for_eas_with_constant_mach2(veq1, mach, velocity_units='ft/s', alt_units='ft', nmax=20)
    ...
    def test_atm_unit_reynolds_number(self):
        ...
        for alt, re_expected in targets:
            rel_a = atm_unit_reynolds_number2b(alt*1000., mach)
            assert np.allclose(rel_a, re_expected, atol=1e-3), 'rel_a=%s re_expected=%s' % (rel_a, re_expected)

            rel_b = atm_unit_reynolds_number2b(alt, mach, alt_units='kft', reynolds_units='1/ft')
