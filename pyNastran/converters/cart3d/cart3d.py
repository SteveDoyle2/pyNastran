...
class Cart3dIO(object):
    ...
    def _read_points_binary(self, npoints):
        ...
        points = np.frombuffer(data, dtype=dtype).reshape((npoints, 3))
    ...
    def _read_elements_binary(self, nelements):
        ...
        elements = np.frombuffer(data, dtype=dtype).reshape((nelements, 3))
    ...
    def _read_regions_binary(self, nelements):
        ...
        regions = np.frombuffer(data, dtype=dtype)
