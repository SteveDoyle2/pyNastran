...
class ShabpIO:
    ...
    def load_shabp_geometry(self, shabp_filename: PathLike,
        ...
        form, cases = _fill_shabp_geometry_case(
...
def _fill_shabp_geometry_case(cases, ID, nodes, elements, patches,
    ...
    XYZc = np.zeros((len(elements), 3), dtype='float32')
    Normal = np.zeros((len(elements), 3), dtype='float32')
    area = np.zeros(len(elements), dtype='float32')
