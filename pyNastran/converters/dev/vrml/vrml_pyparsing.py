...
out = pword_triple.parseString('direction -0.577 -0.577 -0.577', parseAll=False)  # works

# ambientIntensity 1.0
out = pword_float.parseString('ambientIntensity 1.0', parseAll=False)
