...
class NastranIO(NastranGuiResults, NastranGeometryHelper):
    ...
    def _map_elements_vectorized(self, points, nid_map, model, j, dim_max,
        ...
        ieid0, cell_offset0 = self.map_elements_vectorized_fill(
            ieid0, cell_offset0,
            nodes, nids_list,
            eids_array, cell_types_array, cell_offsets_array,
            model.celas1, cell_type_line, nnodesi=2, dimi=1)
        ieid0, cell_offset0 = self.map_elements_vectorized_fill(
            ieid0, cell_offset0,
            nodes, nids_list,
            eids_array, cell_types_array, cell_offsets_array,
            model.celas2, cell_type_line, nnodesi=2, dimi=1)
        ieid0, cell_offset0 = self.map_elements_vectorized_fill(
            ieid0, cell_offset0,
            nodes, nids_list,
            eids_array, cell_types_array, cell_offsets_array,
            model.celas3, cell_type_line, nnodesi=2, dimi=1)
        ieid0, cell_offset0 = self.map_elements_vectorized_fill(
            ieid0, cell_offset0,
            nodes, nids_list,
            eids_array, cell_types_array, cell_offsets_array,
            model.celas4, cell_type_line, nnodesi=2, dimi=1)

        ieid0, cell_offset0 = self.map_elements_vectorized_fill(
            ieid0, cell_offset0,
            nodes, nids_list,
            eids_array, cell_types_array, cell_offsets_array,
            model.cdamp1, cell_type_line, nnodesi=2, dimi=1)
        ieid0, cell_offset0 = self.map_elements_vectorized_fill(
            ieid0, cell_offset0,
            nodes, nids_list,
            eids_array, cell_types_array, cell_offsets_array,
            model.cdamp2, cell_type_line, nnodesi=2, dimi=1)
        ieid0, cell_offset0 = self.map_elements_vectorized_fill(
            ieid0, cell_offset0,
            nodes, nids_list,
            eids_array, cell_types_array, cell_offsets_array,
            model.cdamp3, cell_type_line, nnodesi=2, dimi=1)
        ieid0, cell_offset0 = self.map_elements_vectorized_fill(
            ieid0, cell_offset0,
            nodes, nids_list,
            eids_array, cell_types_array, cell_offsets_array,
            model.cdamp4, cell_type_line, nnodesi=2, dimi=1)
        ...
        if nconrod:
            ...
            elem = model.conrod
            elem.make_current()
            nnodes = np.full((nelems, 1), 2, dtype='int32')
            ...
            dim = np.full(nelems, 1, dtype='int32')
    ...
    def map_elements_vectorized_fill(self,
                                     ieid0, cell_offset0,
                                     nodes, nids_list,
                                     eids_array, cell_types_array, cell_offsets_array,
    ...
    def map_elements(self, points, nid_map, model, j, dim_max,
        ...
        if IS_TESTING:
            self._map_elements3(points, nid_map, model, j, dim_max,
                                nid_cp_cd, plot=plot, xref_loads=xref_loads)
        #return self._map_elements3(points, nid_map, model, j, dim_max,
                                   #nid_cp_cd, plot=plot, xref_loads=xref_loads)
