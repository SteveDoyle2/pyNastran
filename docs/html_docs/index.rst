...
The **BDF reader/writer** supports 406 cards including coordinate
...
The **OP2 reader/writer** supports static/transient results, which unless you
analyzing frequency response data should be good enough. It also supports
**OP2/F06 Writing** for most of the objects. Results include: displacement,
