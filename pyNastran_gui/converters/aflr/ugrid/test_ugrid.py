...
from pyNastran_gui.converters.nastran.nastran_to_ugrid3d import merge_ugrid3d_and_bdf_to_ugrid3d_filename
from pyNastran_gui.converters.aflr.ugrid.ugrid3d_to_nastran import ugrid3d_to_nastran
...
PKG_PATH2 = pyNastran_gui.__path__[0]
NASTRAN_PATH = os.path.join(PKG_PATH, '..', 'models')
UGRID_PATH = os.path.join(PKG_PATH2, 'converters', 'aflr', 'ugrid', 'models')
TECPLOT_PATH = os.path.join(PKG_PATH2, 'converters', 'tecplot', 'models')
