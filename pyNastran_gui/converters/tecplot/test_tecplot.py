...
from pyNastran_gui.converters.tecplot.tecplot import read_tecplot
from pyNastran_gui.converters.tecplot.tecplot_to_nastran import tecplot_to_nastran_filename
from pyNastran_gui.converters.nastran.nastran_to_tecplot import (
...
MODEL_PATH = os.path.join(PKG_PATH2, 'converters', 'tecplot', 'models')
