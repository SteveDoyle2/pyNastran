...
from pyNastran_gui.gui import IS_DEV
import pyNastran_gui.gui.formats
import pyNastran_gui.gui.gui_common
#if not IS_DEV:
    #from pyNastran.gui.menus.test_groups import *
from pyNastran_gui.converters.test_gui_formats import *
from pyNastran_gui.converters.test_formats import *
