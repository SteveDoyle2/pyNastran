...
vtk_imports = [  # 9.3
    #'vtk', 
    'vtkmodules', 'vtkmodules.qt', 'vtkmodules.util', 'vtkmodules.util.misc', 'vtkmodules.util.numpy_support', 
...
vtk_imports = [
    'vtkmodules', 'vtkmodules.vtkCommonDataModel', 'vtkmodules.vtkCommonMath',
...
if BUILD_EXE:
    ...
    if MAKE_SPLASH:
        ...
        exe = EXE(pyz,
                  ...
                  splash,
                  splash.binaries,
                  exe_binaries,  # [('v', None, 'OPTION')] was never active..
                  a.zipfiles,
                  a.datas,
