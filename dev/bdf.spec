...
a4 = os.path.join(pkg_path, 'bdf','mesh_utils', 'utils.py')
...
icon_main = 'bdf_logo.ico' # pyInstaller doesn't like paths in the ico
...
hiddenimports = [] #scipy_imports + ['scipy.special', 'scipy.special._ufuncs_cxx']
...
exe = EXE(pyz,
          ...
          name=os.path.join('build\\pyi.win32\\bdf', 'tbdf.exe'),
          debug=DEBUG,
          strip=None,
          #upx=True,
          icon=icon_main,
