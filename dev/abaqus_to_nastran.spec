...
for line in lines:
    ...
    elif '__version_release__ = ' in line:
        # __version_release__ = '1.1.0'
        print(line)
        version_fmt = line.split("'")[1]  # '1.1.0'
...
a4 = os.path.join(pkg_path, 'converters', 'abaqus', 'abaqus_to_nastran.py')
...
excludes = [
    ...
    'path.py', 'pep8', 'pi', 'pip',
    'psutil', 'py', 'pylint', 'pyside','pyside2', 'pyqt5', 'pyside6', 'pyqt6', 'pytest',
...
gui_imports = [
    ...
    'vtk.vtkRenderingPythonSIP', 'vtkmodules', 'pygments',] + qt_imports

excludes += h5py_imports
excludes += gui_imports
...
exe = EXE(pyz,
          ...
          name=os.path.join('build\\pyi.win32\\abaqus_to_nastran', 'abaqus_to_nastran.exe'),
          debug=DEBUG,
          strip=None, #
