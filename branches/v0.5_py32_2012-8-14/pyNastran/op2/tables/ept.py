...
# PLSOLID
    ...
    def readPSOLID(self,data):
        ...
        while len(data)>=28: # 7*4
            eData = data[:28]
            data  = data[28:]
            (pid,mid,cid,inp,stress,isop,fctn) = unpack('6i4s',eData)
...
# PTSHELL
    ...
    def readPTUBE(self,data):
        ...
        while len(data)>=20: # 5*4
            eData = data[:20]
            data  = data[20:] # or 24
            (pid,mid,OD,t,nsm) = unpack('2i3f',eData)
