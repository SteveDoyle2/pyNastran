...
MOCK_MODULES = ['numpy', 'scipy', 'matplotlib', 'vtk', 'wx', 'PyQt4', 'PySide', 'docopt']
...
latex_documents = [
  ('index', 'pyNastran.tex', u'pyNastran Documentation',
   u'Steven Doyle \\and Al Danial', 'manual'),
]
...
texinfo_documents = [
  ('index', 'pyNastran', u'pyNastran Documentation',
   u'Steven Doyle, Al Danial', 'pyNastran', 'Nastran BDF/F06/OP2/OP4 '
...
epub_author = u'Steven Doyle, Al Danial'
epub_publisher = u'Steven Doyle, Al Danial'
epub_copyright = u'2012, Steven Doyle, Al Danial'
